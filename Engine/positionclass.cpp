...
bool PositionClass::SetCameraType()
{
	return m_cameraType;
}
...
void PositionClass::MoveUpward(bool keydown, float accel, float maxSpeed, float speed)
{
	// Update the upward speed movement based on the frame time and whether the user is holding the key down or not.
	if(keydown)
	{
		m_upwardSpeed += m_frameTime * speed;

		if(m_upwardSpeed > (m_frameTime * speed))
		{
			m_upwardSpeed = m_frameTime * speed;
		}
	}
