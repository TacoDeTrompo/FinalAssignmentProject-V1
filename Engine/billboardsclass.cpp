...
bool billboardsclass::Estrategia()
{
	m_vertexCount = 4;
	m_indexCount = 6;
...
D3DXMATRIX billboardsclass::generateWorldMAtrix(D3DXVECTOR3 cameraPosition, D3DXVECTOR3 modelPosition)
{
...
billboardsclass::billboardsclass()
{
}
