...
public:
	...
	void Shutdown();
	bool Render(ID3D11DeviceContext*, FontShaderClass*, D3DXMATRIX, D3DXMATRIX, bool, bool, bool, int, int, int, int);
...
private:
	...
	SentenceType *m_Number0, *m_Number1, *m_Number2, *m_Number3, *m_Number4, *m_Number5, *m_Number6, *m_Number7, *m_Number8, *m_Number9;
};
